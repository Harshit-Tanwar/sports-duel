...
const CountUpdate = ({
  ...
  <div className="flex items-center gap-4 bg-black rounded-full border-2 border-blue-500 shadow-[0_0_10px_rgba(0,152,255,0.5)] px-1 py-1 relative">
    <button
      onClick={onMinus}
      className="w-8 h-8 rounded-full bg-white text-black font-bold text-lg flex items-center justify-center hover:bg-gray-200 transition-colors"
    >
      −
    </button>
